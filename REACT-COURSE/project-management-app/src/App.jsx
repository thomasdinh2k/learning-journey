...
function App() {
	...
	const handleCreateTodo = (projectId, title) => {
		...
		setProjectState( prevState => ({
			...
			projects: prevState.projects.map( project => {
				if (project.id === projectId) {
					console.log(`Found projectID ${projectId}, start updating`);
					return {...project, tasks: [newTodo, ...project.tasks]}
				}
		...
		console.log("Complete add todo", projectState);
	};
	...
	const handleDeleteTodo = (projectId, taskId) => {
		setProjectState( prevState => {
			return {
				...
				projects: prevState.projects.map( project => {
					if (project.id === projectId) {
						return {...project, tasks: project.tasks.filter( todo => todo.id != taskId)}
					}
